...
[![release](https://img.shields.io/github/tag-date/traefik/yaegi.svg?label=alpha)](https://github.com/breadchris/yaegi/releases)
[![Build Status](https://github.com/breadchris/yaegi/actions/workflows/main.yml/badge.svg)](https://github.com/breadchris/yaegi/actions/workflows/main.yml)
[![GoDoc](https://godoc.org/github.com/breadchris/yaegi?status.svg)](https://pkg.go.dev/mod/github.com/breadchris/yaegi)
...
```go
import "github.com/breadchris/yaegi/interp"
```

### Command-line executable

```bash
go install github.com/breadchris/yaegi/cmd/yaegi@latest
```
...
```console
$ yaegi -syscall -unsafe -unrestricted github.com/breadchris/yaegi/cmd/yaegi
>
```
...
Go modules are not supported yet. Until that, it is necessary to install the source into `$GOPATH/src/github.com/breadchris/yaegi` to pass all the tests.
...
[docs]: https://pkg.go.dev/github.com/breadchris/yaegi
[license]: https://github.com/breadchris/yaegi/blob/master/LICENSE
[github]: https://github.com/breadchris/yaegi
[bugs]: https://github.com/breadchris/yaegi/issues?q=is%3Aissue+is%3Aopen+label%3Abug
