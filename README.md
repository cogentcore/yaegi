...
[![release](https://img.shields.io/github/tag-date/traefik/yaegi.svg?label=alpha)](https://github.com/cogentcore/yaegi/releases)
[![Build Status](https://github.com/cogentcore/yaegi/actions/workflows/main.yml/badge.svg)](https://github.com/cogentcore/yaegi/actions/workflows/main.yml)
[![GoDoc](https://godoc.org/github.com/cogentcore/yaegi?status.svg)](https://pkg.go.dev/mod/github.com/cogentcore/yaegi)
...
```go
import "github.com/cogentcore/yaegi/interp"
```

### Command-line executable

```bash
go install github.com/cogentcore/yaegi/cmd/yaegi@latest
```
...
```console
$ yaegi -syscall -unsafe -unrestricted github.com/cogentcore/yaegi/cmd/yaegi
>
```
...
Go modules are not supported yet. Until that, it is necessary to install the source into `$GOPATH/src/github.com/cogentcore/yaegi` to pass all the tests.
...
[docs]: https://pkg.go.dev/github.com/cogentcore/yaegi
[license]: https://github.com/cogentcore/yaegi/blob/master/LICENSE
[github]: https://github.com/cogentcore/yaegi
[bugs]: https://github.com/cogentcore/yaegi/issues?q=is%3Aissue+is%3Aopen+label%3Abug
